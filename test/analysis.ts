...
describe("Analysis", (): void => {
    ...
    it("Should find the best move Bd5 at the requested depth with winning evaluation", (done: Function): void => {
    ...
    it("Should find the best move Qg3 at the requested depth with winning evaluation", (done: Function): void => {
        const engine = new Engine("./engine/stockfish_20090216_x64");
